...
public class Extract implements Serializable{
	...
	public static Extract builder(Account accountOrigin, Account accountDestine, TypeOperation operation, String valueTransaction) {
        return new Extract(null , LocalDate.now(), accountOrigin.getNumberAgency(), accountOrigin.getNumberAccount(),
                accountDestine.getNumberAgency(), accountDestine.getNumberAccount(), operation, valueTransaction,  accountOrigin.getBalance());
    }
    
    public static Extract builder(Account accountOrigin, TypeOperation operation, String valueTransaction) {
        return new Extract(null , LocalDate.now(), accountOrigin.getNumberAgency(), accountOrigin.getNumberAccount(),
